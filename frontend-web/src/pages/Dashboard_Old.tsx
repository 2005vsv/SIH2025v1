      ...
      <div className="container mx-auto px-4 py-8">
        ...
        >
          ...
          <p className="text-gray-600 text-lg">
            Here's what you can do in your student portal
          </p>
        </motion.div>
        ...
        <motion.div
          ...
          className="mt-12 bg-white/80 backdrop-blur-lg rounded-2xl p-6 shadow-lg border border-white/20"
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div className="text-center">
              ...
              <div className="text-gray-600">Fees Pending</div>
            </div>
            <div className="text-center">
