        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          >
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-medium text-gray-500 dark:text-gray-400">Room Status</p>
          ...
          >
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-semibold text-gray-900 dark:text-white">{availableRooms.length}</p>
              </div>
            </div>
          </motion.div>
          ...
          >
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-medium text-gray-500 dark:text-gray-400">Maintenance Requests</p>
                <p className="text-2xl font-semibold text-gray-900 dark:text-white">{maintenanceRequests.length}</p>
              </div>
            </div>
          </motion.div>
        </div>
              ...
              {booking ? (
                <div className="space-y-6">
                  <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="space-y-3">
                        ...
                        <div className="flex justify-between">
                          <span className="text-sm text-gray-500 dark:text-gray-400">Occupancy:</span>
                          <span className="text-sm font-medium text-gray-900 dark:text-white">
                  ...
                  {booking.roomId.amenities.length > 0 && (
                    <div>
                      <h4 className="text-md font-medium text-gray-900 dark:text-white mb-3">Amenities</h4>
                ...
                <div className="text-center py-12">
                  ...
                  <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-2">No Room Assigned</h3>
                  ...
                  >
                    ...
                    <div className="grid grid-cols-3 gap-4 mb-4">
                      <div className="text-center">
                        ...
                        <p className="font-semibold text-gray-900 dark:text-white">{room.capacity} beds</p>
                      </div>
                      <div className="text-center">
                        <p className="text-sm text-gray-500 dark:text-gray-400">Current Occupancy:</p>
                        <p className="font-semibold text-gray-900 dark:text-white">{room.occupancy}/{room.capacity}</p>
                      </div>
                      <div className="text-center">
                        <p className="text-sm text-gray-500 dark:text-gray-400">Monthly Rent:</p>
                        <p className="font-semibold text-gray-900 dark:text-white">₹{room.monthlyRent.toLocaleString()}</p>
                      </div>
                    </div>
                      ...
                      <div className="mb-4">
                        ...
                        <div className="flex flex-wrap gap-2">
                          ...
                          {room.amenities.length > 3 && (
                            <span className="inline-flex px-2 py-1 text-xs bg-gray-100 text-gray-600 dark:bg-gray-600 dark:text-gray-300 rounded">
            ...
            <div className="p-6">
              ...
              {maintenanceRequests.length === 0 && (
                <div className="text-center py-12">
                  ...
                  <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-2">No maintenance requests</h3>
                  <p className="text-gray-500 dark:text-gray-400">
