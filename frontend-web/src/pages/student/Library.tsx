import { Book, BookOpen, Clock, Search, Star } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          >
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-bold text-gray-900 dark:text-white">{activeBorrowedBooks.length}</p>
              </div>
            </div>
          </motion.div>
          ...
          >
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-medium text-gray-600 dark:text-gray-400">Available Books</p>
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between mb-4">
                      <div className="text-sm text-gray-600 dark:text-gray-400">
                        Available: <span className="font-medium">{book.availableCopies}/{book.totalCopies}</span>
                      </div>
                      <div className="flex items-center">
