...
const { GamificationPoint } = require('../models/Gamification');

// Remove all TypeScript syntax and use CommonJS exports
...
// ... (Repeat the same fix for all other exported functions: remove TypeScript syntax, use module.exports or exports, and fix destructuring/aggregate bugs as above)
...
exports.getLibraryAnalytics = async (req, res) => {
  try {
    const { period = 'month' } = req.query;
