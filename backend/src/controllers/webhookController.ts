...
const handlePaymentFailure = async (paymentData: any): Promise<void> => {
  try {
...
const handlePaymentRefund = async (paymentData: any): Promise<void> => {
  try {
    ...
    if (fee) {
      // Update fee status back to pending (you might want to add a 'refunded' status to the enum)
      fee.status = 'pending';
      // Note: The current Fee model doesn't have refund fields, so we'll just update the status
      // You might want to add refundId, refundAmount, refundDate fields to the Fee model
      await fee.save();
...
// Handle incoming SMS
const handleIncomingSMS = async (smsData: any): Promise<void> => {
  try {
    ...
    if (user) {
      ...
      if (command.includes('fees') || command.includes('fee')) {
        await sendFeeStatusSMS((user._id as any).toString(), from);
      } else if (command.includes('attendance')) {
        await sendAttendanceStatusSMS((user._id as any).toString(), from);
...
const sendFeeStatusSMS = async (userId: string, phoneNumber: string): Promise<void> => {
  try {
...
const sendAttendanceStatusSMS = async (userId: string, phoneNumber: string): Promise<void> => {
  try {
...
// Send help SMS
const sendHelpSMS = async (phoneNumber: string): Promise<void> => {
  try {
...
export const handleThirdPartyWebhook = async (req: Request, res: Response): Promise<void> => {
  try {
...
// Handle LMS webhooks
const handleLMSWebhook = async (event: string, data: any): Promise<void> => {
  try {
    switch (event) {
...
// Handle ERP webhooks
const handleERPWebhook = async (event: string, data: any): Promise<void> => {
  try {
    switch (event) {
...
const handleLibraryWebhook = async (event: string, data: any): Promise<void> => {
  try {
    switch (event) {
      case 'book.issued':
...
const handleCourseEnrollment = async (data: any): Promise<void> => {
...
const handleAssignmentSubmission = async (data: any): Promise<void> => {
...
const handleGradeUpdate = async (data: any): Promise<void> => {
...
const handleFeeUpdate = async (data: any): Promise<void> => {
...
const handleAttendanceUpdate = async (data: any): Promise<void> => {
...
const handleBookIssued = async (data: any): Promise<void> => {
...
const handleBookReturned = async (data: any): Promise<void> => {
...
const handleBookOverdue = async (data: any): Promise<void> => {
